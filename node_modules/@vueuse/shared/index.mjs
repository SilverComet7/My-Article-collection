import { computed, unref, watch, ref, customRef, isVue3, isRef, effectScope, onScopeDispose, shallowRef, watchSyncEffect, readonly, reactive, toRef, isVue2, toRefs as toRefs$1, getCurrentInstance, onBeforeUnmount, onMounted, nextTick, getCurrentScope, onUnmounted } from 'vue-demi';
