- 什么是 ChatGPT
  ChatGPT 模型是由 OpenAI 训练的大型语言模型，能够生成类似人类的文本。通过为其提供提示，它可以生成继续对话或扩展给定提示的响应。
- 能做什么
- 无法访问
  - 429
  - NOT AVAILABLE COUNTRY
- ChatGPT 提问技巧
使用精确的提问：尽可能使用简短明确的话题，把提问的范围缩小到一个较小的范围。

使用关键词：选择一些可以概括整个问题的关键词，以便让 ChatGPT 更好地理解您的意图。

使用约束：尽量提供一些能够帮助 ChatGPT 回答问题的有限信息。

使用虚拟对话：使用虚拟对话，就像和一个真实的朋友聊天一样，把问题表达的尽可能地清楚。

对回答提出补充问题：如果 ChatGPT 的回答还不够满意，可以适当补充一些问题，从而获得更好的回答。
